...
parameters = {
    ...
    'S5F':dict(
        save_path = "/localdata/alignairr_data/AlignAIRR_Evaluation_Dataset/LightChain_OGRDB_DataConfig_AlignAIRR_S5F_5M_without_Corruption_Mrate.csv",
        BATCH_SIZE = 100_000,
...
if __name__ == '__main__':
    ...
    args = SequenceAugmentorArguments(mutation_model=S5F,nucleotide_remove_coefficient=230,corrupt_proba=0)
    simulator = LightChainKappaLambdaSequenceAugmentor(lambda_args=args,
                                            kappa_args=args,

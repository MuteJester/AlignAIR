...
parameters = {
    ...
    'S5F':dict(
        save_path = "/localdata/alignairr_data/AlignAIRR_Large_Train_Dataset/LightChain_OGRDB_DataConfig_AlignAIRR_S5F_15M_with_Corruption_Mrate_003__025.csv",
        BATCH_SIZE = 100_000,
...
if __name__ == '__main__':
    ...
    args = SequenceAugmentorArguments(mutation_model=S5F,nucleotide_remove_coefficient=230)

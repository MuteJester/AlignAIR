...
parameters = {
    ...
    'Uniform':dict(
        save_path = "/localdata/alignairr_data/AlignAIRR_Evaluation_Dataset/HeavyChain_OGRDB_AlignAIRR_Uniform_5M_No_Corruption.csv",
        BATCH_SIZE = 100_000,
    ...
    'S5F':dict(
        save_path = "/localdata/alignairr_data/AlignAIRR_Evaluation_Dataset/HeavyChain_OGRDB_AlignAIRR_S5F_5M_No_Corruption.csv",
        BATCH_SIZE = 100_000,
        num_samples = 5_000_000,
        MUTATION_MODEL = S5F,
        CMMP = None,
    ...
    'S5F_60':dict(
        save_path = "/localdata/alignairr_data/AlignAIRR_Evaluation_Dataset/HeavyChain_OGRDB_AlignAIRR_S5F_60_5M_No_Corruption.csv",
        BATCH_SIZE = 100_000,
        num_samples = 5_000_000,
        MUTATION_MODEL = S5F,
    ...
    'S5F_Opposite':dict(
        save_path = "/localdata/alignairr_data/AlignAIRR_Evaluation_Dataset/HeavyChain_OGRDB_AlignAIRR_S5F_Opposite_5M_No_Corruption.csv",
        BATCH_SIZE = 100_000,
        num_samples = 5_000_000,
        MUTATION_MODEL = S5F,
...
if __name__ == '__main__':
    ...
    args = SequenceAugmentorArguments(corrupt_proba=0,mutation_model=MUTATION_MODEL,custom_mutation_model_path=CMMP)

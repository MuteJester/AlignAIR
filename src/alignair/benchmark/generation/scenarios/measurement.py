...
MEASUREMENT_SCENARIOS: tuple[MeasurementScenario, ...] = (
    ...
    MeasurementScenario(
        ...
        stratum_names=("clean_full", "moderate_full", "trimmed", "fragment_120", "fragment_80", "fragment_50"),
    ...
    MeasurementScenario(
        ...
        stratum_names=("clean_full", "fragment_120", "fragment_80", "fragment_50", "ultra_short_fragment_40"),
        required_coverage_labels=(
        ...
        controlled_variables=("short-read windows are junction-centered unless explicitly adaptive-anchored",),
    ),
    MeasurementScenario(
        name="shm_isolation",
        status="integrated",

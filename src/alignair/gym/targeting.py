...
class TargetedCurriculum:
    ...
    the factored ramp (majority), an ALP/regret-targeted lattice cell (the current
    highest-priority weakness), and a fixed hard-corner floor (anti-forgetting). The gym
    draws one component per epoch, so the long-run sampling distribution is the mixture."""

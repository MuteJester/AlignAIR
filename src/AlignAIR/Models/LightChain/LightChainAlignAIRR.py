...
from ..Layers import ConvResidualFeatureExtractionBlock
from ..Layers import (
...
class LightChainAlignAIRR(tf.keras.Model):
    ...
    def predict_segments(self, concatenated_signals):
        ...
        return v_segment, j_segment, mutation_rate,chain_type,indel_count
    ...
    def call(self, inputs):
        ...
        v_segment, j_segment, mutation_rate, chain_type, indel_count = self.predict_segments(segmentation_features)
    ...
    def multi_task_loss(self, y_true, y_pred):
        ...
        total_loss = (
                ...
                + mutation_rate_loss + chain_type_loss + indel_count_loss

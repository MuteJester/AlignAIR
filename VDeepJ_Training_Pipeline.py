...
v_dict, d_dict, j_dict = prepper.get_family_gene_allele_map(
...
) = prepper.convert_calls_to_one_hot(data["v_gene"], data["v_allele"], data["v_family"])
(
    d_family_call_ohe,
...
) = prepper.convert_calls_to_one_hot(data["d_gene"], data["d_allele"], data["d_family"])
(
    j_gene_call_ohe,
    j_gene_call_ohe_np,
    j_allele_call_ohe,
    j_allele_call_ohe_np,
) = prepper.convert_calls_to_one_hot(data["j_gene"], data["j_allele"])

...
models_path = "/localdata/alignairr_data/sf5_unboundedadd_10082023/saved_models/"
...
model_path = "/localdata/alignairr_data/sf5_unboundedadd_10082023/saved_models/tmp"
...
# )
saved_pred_dict_path = "/localdata/alignairr_data/sf5_unboundedadd_10082023/pred/"
...
pred_dict = trainer.predict(pred_file_path, account_for_padding=False)

save_pred_dict_name = (
    "model__" + model_name + "__data__" + "naive_sequences_clean.pkl"
)
